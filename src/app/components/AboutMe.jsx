    ...
    <div className=' lg:w-[1300px] w-full  flex flex-col '>
        ...
        className='lg:flex lg:items-center font-poppins lg:justify-center grid justify-items-center w-full h-auto gap-6 m my-10 lg:my-20 lg:pb-0  lg:px-4 py-4 shadow-black rounded-2xl bg-neutral-900 lg:h-[340px]  shadow-2xl'>
            ...
            <div className='flex flex-col items-center justify-center h-full gap-6 lg:gap-7 lg:w-1/3'>
                <p className='text-center text-white font-extralight text-md lg:text-lg'>Estudiante de sistemas en la Unviersidad Tecnologica Nacional, autodidacta y estusiasta por el desarrollo web. Motivado a seguir sumando conocimientos para aplicarlos en el entorno profesional.</p>
                <div className='flex items-center justify-center w-full' >
                    <a target='_blank' href="https://drive.google.com/file/d/1BEzlDHPOTEe3bUA4HZMYYY93aOAO-ugY/view?usp=sharing">
